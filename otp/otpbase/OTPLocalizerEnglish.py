...
CRBootedReasons = {1: 'An unexpected problem has occurred.  Your connection has been lost, but you should be able to connect again and go right back into the game.',
 ...
 154: 'Toonbox is now temporarily closed for maintenance. Everyone who was playing has been disconnected from the game.\n\nFor more information, please visit the Toonbox website.',
...
CRMaintenanceCountdownMessage = 'Attention Toons! Toonbox will be going down for maintenance in %d minutes.'
CRMaintenanceMessage = 'Attention Toons! Toonbox is now going down for maintenance.'
...
FriendSecretIntro = "If you are playing Toonbox with someone you know in the real world, you can become True Friends.  You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on his or her screen, you'll be True Friends in Toontown!"
...
FriendSecretDetermineSecretAccountRollover = 'A friend across the Toonbox network'
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 30511: "You can report bugs by clicking the Report a Bug button on the Toonbox launcher."}

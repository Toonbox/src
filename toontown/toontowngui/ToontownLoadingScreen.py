...
class ToontownLoadingScreen():
    ...
    def __init__(self):
        ...
        self.title = DirectLabel(guiId='ToontownLoadingScreenTitle', parent=self.gui, relief=None, pos=(-1.06, 0, -0.77), text='', textMayChange=1, text_scale=0.08, text_fg=(0.00, 0.58039215686274509803921568627451, 0.9960784313725490196078431372549, 1), text_align=TextNode.ALeft, text_font=ToontownGlobals.getSignFont())
